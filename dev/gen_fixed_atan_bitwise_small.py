...
def main():
    out = []
    o = out.append
    o("/* Generated by dev/gen_fixed_atan_bitwise_small.py -- register")
    o("   implementations of the fixed_atan_bitwise_rs vectoring for")
    o("   small n -- do not edit by hand. */")
    o("")
