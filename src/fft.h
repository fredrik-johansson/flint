...
struct mpn_negmul_ctx_struct;
#define FLINT_FFT_NEGMUL_MIN_RING 16384  /* bits */
slong fft_negmul_choose_limbs(slong tight, slong n_outer, slong * m_out);
void _fft_negmul_pointwise(struct mpn_negmul_ctx_struct * negctx,
                   mp_limb_t ** ii, mp_limb_t ** jj, slong j0, slong j1,
                   slong limbs);

void _fft_negmul_pointwise_rows(struct mpn_negmul_ctx_struct * negctx,
