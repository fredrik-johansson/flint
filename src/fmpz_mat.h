...
ulong _fmpz_mat_find_good_prime_and_lu2(nmod_mat_t LU, slong * P, const fmpz_mat_t A, const fmpz_t det_bound, slong bits);
...
#define FMPZ_MAT_STARTING_PRIME() (flint_fmpz_mat_force_small_primes ? UWORD(1) : (UWORD(1) << NMOD_MAT_OPTIMAL_MODULUS_BITS))
