...
#ifndef MACHINE_VECTORS_AVX2_H
#define MACHINE_VECTORS_AVX2_H

#ifndef MACHINE_VECTORS_H
# error machine_vectors_avx2.h should be included only via machine_vectors.h
#endif
/*
